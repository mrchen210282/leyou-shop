...
import com.leyou.user.service.mapper.BackUserMapper;
...
//        }
    ...
    public BackUser queryBackUserByIdAndPassword(String username, String password) {
        BackUser record = new BackUser();
        record.setUsername(username);
        BackUser user = this.backUserMapper.selectOne(record);
        if (user == null) {
            return null;
        }
        String passwordSql = user.getPassword();
